...
while fila_actual < len(df):
    ...
    datospatron = df.iloc[9, 1:7].astype(int)  # Fila de los datos patrón
    datos_seleccionados = df.iloc[fila_actual + 7, 1:7].astype(float)  # Fila de los datos seleccionados
