...
while True:
    if fila_inicial >= len(df):
        ...
        print(nocertificado)
        output_path = "PULIR/Basculas/Certificados/" + nocertificado + ".pdf"
        background_image_path = "/home/raven/CODE/PULIR/Basculas/backCertificado.png"
        ...
        resolucion = str(df.iat[fila_inicial + 10, 1])   
        print(serie)
